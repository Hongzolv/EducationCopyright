...
class FCN:
    ...
    def build(self):
        ...
        # Weight shape 설정===>width: 3, height: 3, in: 256 out: 512
        # Bias 설정=====>out: 512
        conv_4_1 = self.conv_layer(pool_3, [3, 3, 256, 512], 512, 'conv_4_1')
        # Weight shape 설정===>width: 3, height: 3, in: 512 out: 512
        # Bias 설정=====>out: 512
        ...
        # Weight shape 설정===>width: 7, height: 7, in: 512 out: 4096
        # Bias 설정=====>out: 4096
        fc_6 = self.conv_layer(pool_5, [7, 7, 512, 4096], 4096, 'fc_6')
        # Weight shape 설정===>width: 1, height: 1, in: 4096 out: 4096
        # Bias 설정=====>out: 4096
